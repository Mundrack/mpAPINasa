...
namespace mpAPINasa.ViewModels
{


    public class MPApodViewModel : INotifyPropertyChanged
    {
        ...
        private MPApodService service;
        public MPApodService Service
        {
            get
            {
                if (service == null)
                {
                    service = new MPApodService();
                }
                return service;
            }
        }
        ...
        {
            MPapod dto = await Service.GetImage(day);
            if (dto == null)
            {
